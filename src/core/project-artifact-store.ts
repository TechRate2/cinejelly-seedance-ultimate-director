...
export class ProjectArtifactStore {
  ...
  private payloads(result: DirectorRunResult, costLedger: readonly CostLedgerEntry[]): readonly ProjectArtifactPayload[] {
    ...
    const runSummary = {
      ...
      videoRenderWorkflowMode: result.videoRenderStrategyPlan.workflowMode,
      videoRenderContinuityMode: result.videoRenderStrategyPlan.continuityMode,
      videoRenderRequestedMode: result.videoRenderStrategyPlan.requestedMode,
      videoRenderRequiresSequentialRender: result.videoRenderStrategyPlan.requiresSequentialRender,
      ...
      renderScheduleBatchCount: result.renderSchedulePlan.batchCount,
      renderScheduleParallelBatchCount: result.renderSchedulePlan.parallelBatchCount,
      renderScheduleSequentialShotCount: result.renderSchedulePlan.sequentialItemCount,
    ...
    const payloads: ProjectArtifactPayload[] = [
      ...
      { kind: "render_schedule", fileName: "render-schedule.json", value: result.renderSchedulePlan },
