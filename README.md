...
- Atlas provider cost ledger entries now record actual retry counts for retryable LLM, Seedance, prediction polling, and Asset Library HTTP calls.
...
49. Real end-to-end validation with Atlas credentials and FFmpeg/FFprobe installed - next
