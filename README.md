...
4. Run one paid Atlas validation render using `npm.cmd run validation:paid-render -- --request <request-json> --confirm-paid-spend` with a short non-sensitive operator-supplied request after explicitly approving Atlas credit spend.
