...
Preflight validates generated-audio capability JSON shape when it is configured, while keeping Atlas generated-audio execution disabled when no reviewed capability records are present.
