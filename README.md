...
- The planning path now emits a typed storyboard from shot contracts before render spend; storyboard panels are stored in the Production Graph and durable artifacts.
...
46. Real end-to-end validation with Atlas credentials and FFmpeg/FFprobe installed - next
