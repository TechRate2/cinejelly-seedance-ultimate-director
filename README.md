...
- Runtime validation currently has real Atlas credentials, verified local FFmpeg/FFprobe access, a 60/60 Phase 6 validation-readiness report, one completed short paid Atlas render, a no-spend client policy quota smoke, and a clean release-candidate release audit. Customer use is still blocked by full commercial evidence for deployment, long-form/source-video/remote-stock/generated-audio paths, billing/admin operations, and production operations.
