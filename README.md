...
- The package now declares `main`, `types`, and ESM `exports` for stable production imports from the built `dist/index.js` surface.
...
81. Real end-to-end validation with Atlas credentials and FFmpeg/FFprobe installed - next
