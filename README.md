...
- `npm run doctor` is the beginner-safe local check: it prepares `.env`, preserves existing secrets, detects media tools, runs the no-spend local smoke, summarizes readiness, and never runs paid Atlas rendering.
