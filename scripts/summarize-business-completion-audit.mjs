...
function buildProductCodeGaps() {
  return [
    ...
    },
    {
      ...
      status: "semantic_audio_review_contract_ready",
      currentCoveragePercent: 73,
      sourceEvidence: "docs/SNAPSHOT_FUNCTION_PARITY_AUDIT_2026-06-17.md",
      sourcePatternOrigins: ["jiaminchen-1031/DirectorBench"],
      requiredAction:
        "Run validation:quality-benchmark on real 2-8 minute paid artifacts with actual detected transition boundaries plus structured semantic and audio review JSON, then add generated-audio provider evidence and optional VLM/ASR/lip-sync review before claiming DirectorBench-style parity.",
      canAutomateNow: true,
      blocksApiCliCommercialLaunch: false,
      blocksFullSnapshotParity: true,
      releaseImpact:
