...
const reportCatalog = [
  ...
  report("product_url_extraction_smoke", "short", "backend_code", "assets/output_deliverables/business-readiness/product-url-extraction-smoke-report.json", "pass"),
...
const auditedValidationCommandNames = [
  ...
  "validation:product-url-extraction",
