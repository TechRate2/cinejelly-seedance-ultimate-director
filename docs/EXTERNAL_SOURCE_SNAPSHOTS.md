...
| `vibeframe` | Deterministic artifact naming, validate/plan/build/inspect/repair loop, dry-run/cost gate sequence, build reports, review reports, repair loop ordering, provider routing and status refresh discipline. | MIT-compatible. Guardian repair-decision provenance and provider polling/retry/cost fidelity foundations implemented on 2026-06-13; paid provider validation remains pending. |
