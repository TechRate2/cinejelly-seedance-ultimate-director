...
| `openmontage` | Reference-video analysis, approval gates, provider scoring, real-footage path, self-review loop. | AGPL-3.0. Use architecture and behavior notes unless AGPL obligations or legal approval allow direct implementation reuse. Material source validation uses approval-gate concepts as behavior notes only. |
