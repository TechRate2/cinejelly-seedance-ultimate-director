...
- Archive accepted long-form validation report JSON from a real paid 2-8 minute Atlas run, artifact validation, cost ledger, and manual quality/redaction review.
