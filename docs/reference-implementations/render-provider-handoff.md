...
4. The coordinator reports handoff actions and the action ledger makes those action intents idempotent; neither recreates render requests nor continues the full Director graph after process loss.
