...
- Behavior-critical upstream parity still needs per-logic Reference Implementations, source lineage records, and validation before CineJelly should claim high-fidelity translation for each new logic area. Phase 1 Prompt Binding Plan and Phase 2 Guardian Repair Decision Provenance now have Reference Implementations, CineJelly rewrites, lineage records, and typecheck validation; real Atlas render validation remains pending.
