...
- `src/types` defines the provider, production, prompt, graph, guardian, assembly, media, caption, audio, transition, visual-inspection, stage progress, agent, and runtime-preflight contracts.
