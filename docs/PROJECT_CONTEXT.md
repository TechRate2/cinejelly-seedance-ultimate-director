...
- `Render Job History Persistence`: optionally stores compact, redacted terminal async job summaries at `CINEJELLY_API_JOB_HISTORY_PATH` and restores them after API restart with explicit compact-history markers.
