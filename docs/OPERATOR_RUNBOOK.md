...
Preflight validates `ATLASCLOUD_GENERATED_AUDIO_CAPABILITIES_JSON` shape when configured, and reports generated-audio execution as disabled when no reviewed capability records are present.
