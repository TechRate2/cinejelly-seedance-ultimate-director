...
- Director-style benchmark reports expose artifact-kind facts, redacted local media metadata/proxy signals, redacted transition-boundary proxy summaries, aggregate audio waveform/volume and audio-video duration proxy summaries, optional structured semantic-review checkpoint summaries, optional structured audio-review checkpoint summaries, optional structured ASR/lip-sync runtime checkpoint summaries, score/confidence summaries, bottlenecks, limitations, release-gate status, and a met/partial/missing parity evidence matrix; they do not expose provider payloads, media bytes, sampled frame paths, raw audio bytes, raw transcripts, tokens, or claim full DirectorBench parity.
