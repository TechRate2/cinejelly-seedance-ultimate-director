...
- Optional compact async render-job history persistence through `CINEJELLY_API_JOB_HISTORY_PATH`, with preflight validation, restored-history markers, and stale active job recovery as canceled/audit-required.
