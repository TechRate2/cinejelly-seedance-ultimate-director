...
- Material sourcing planner, local material library adapter, remote stock material adapter, material source validator, postproduction asset planner, generated-audio intent planning, generated-audio execution planning, generated-audio output validation, generated-audio output batch validation, optional generated-audio batch artifact evidence, generated-audio asset resolution plus catalog preflight, render-job stage progress telemetry, compact render-job history persistence with provider checkpoint summaries, provider-state reconciliation foundation, local provider handoff/lease foundation, HTTPS external lease adapter foundation, and source-material/postproduction artifact validation.
...
- HTTPS external lease adapter foundation for acquire/release/list/active lease-service calls with HTTPS-only base URLs, bearer-auth use without token serialization, strict response validation, and no-spend fake-service validation.
