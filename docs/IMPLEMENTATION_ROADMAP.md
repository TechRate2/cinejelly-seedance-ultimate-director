...
- Director-style benchmark reports expose artifact-kind facts, redacted local media metadata/proxy signals, redacted transition-boundary proxy summaries, optional structured semantic-review checkpoint summaries, optional structured audio-review checkpoint summaries, score/confidence summaries, bottlenecks, limitations, and release-gate status; they do not expose provider payloads, media bytes, sampled frame paths, raw audio bytes, tokens, or claim full DirectorBench parity.
