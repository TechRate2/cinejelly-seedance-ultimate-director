...
- From MoneyPrinterTurbo: one-input video systems benefit from a complete staged pipeline, explicit task progress, optional stop-at stages, audio-only stage boundaries, batch output generation, local-or-remote material sourcing, aspect-aware material selection, subtitle/TTS/BGM stage planning, generated-audio intent capture, generated-audio execution planning, generated-audio output validation, generated-audio output batch reconciliation, generated-audio batch artifact evidence, generated-audio asset resolution/catalog evidence, and multiple operator surfaces such as API, CLI, WebUI, Docker, and one-click launchers.
...
- CineJelly adds a typed Production Graph, a Consistency Guardian, a Model Provider Abstraction Layer, generated-audio execution planning, generated-audio output validation, batch reconciliation and optional artifact evidence, generated-audio asset resolution/catalog preflight, a no-spend generated-audio provider contract boundary, governed material sourcing, batch production evidence, and commercial delivery contracts. These are product architecture extensions based on ViMax, VibeFrame, DirectorBench, VideoAgent, OpenMontage, MoneyPrinterTurbo, Emily2040/seedance-2.0, and Atlas Cloud docs.
...
- `src/core`: Production Graph, continuity ledgers, Consistency Guardian, governed material sourcing, generated-audio execution planning, generated-audio output validation, batch reconciliation and optional artifact evidence, generated-audio asset resolution/catalog validation, batch output planning, assembly/media-processing contracts, cost ledger, and repair decisions.
...
- Record generated-audio intents for narration, BGM, ambience, or SFX as reviewable execution-planning evidence; generated provider results must pass output validation before becoming mix tracks, `asset://` generated outputs must pass reviewed asset resolution before mixing, and CineJelly must not claim generated outputs until a verified provider-backed audio generation stage has produced inspected assets.
